...
Not last, then. It was a small thing, and Viridia despised that it mattered to her, but it loosened something all the same. She stepped over the threshold. Behind her the heavy door drew shut, and Aleric's hands left her shoulders at last, and she had the disorienting sense of being handed off, passed out of one set of careful hands into another.
...
It was long and high-ceilinged, a hall or a chapel once, before someone filled it with rows of chairs and a purpose. Light came down through arched windows in long pale columns. High above, the ceiling had been painted ages ago with a faded scene she could not quite make out: figures with their arms raised, and above them something bright that might have been the sun or might have been a fire. No one else was looking up at it.

Fifty chairs faced a raised platform with a single dark desk. The arrangement was deliberate in a way she felt before she understood it: the newest arrivals seated closest, where every word would reach them and where they could be seen, all at once. A room designed so the front row had nowhere to hide.
...
She was good at this part, at least: the watching. Grief had only sharpened it, stripping away whatever part of her had once wanted to step forward and be included. The one demonstrating the flourish was used to being watched and liked it. The two by the window were performing their friendship a little, for the others.

A tall girl with copper hair turned in her seat and picked Viridia out where she stood. Her eyes did the quick sum strangers do, the loose hair, the slight build, the plainness of her, and landed last on the dark-blue stone at Viridia's throat. They stayed there a moment too long. Then the girl leaned to her neighbor and said something behind two fingers, and both of them looked, and looked away, and laughed. Cruel, Viridia decided, and filed her under it: the kind who picked. It would be weeks before she learned the copper-haired girl had been asking, low and worried, whether the new one had come straight from the funeral she'd heard about, and that the laugh had been the other girl's, at something else entirely. Viridia, this once, had read the surface and called it the depth.
...
It was a small thing, almost nothing, but Alice's whole face lit with sudden pleasure. She smoothed the skirt down over her knees with both hands, a quick proud gesture. "Do you really? I keep thinking it's going to turn out to be a mistake, that someone's going to come and tell me there's been a mix-up." She laughed, soft, so as not to carry. "Nobody in my family's ever. I mean, I'm the first. The first one of us who could do any of it. So all this still feels a bit like I borrowed it." She tucked her hair behind her ear, and there was, for just a second under the brightness, something carefully managed, a self-consciousness she was choosing to wave off rather than let sit. "Is your family, were they all mages? You look like you belong here. You've got that look." And then, lighter, but with a small edge under it she did not seem to hear herself put there: "Old blood, I bet. You can always tell. It must be nice, knowing the room's yours before you walk into it."

It was not meant unkindly. Viridia understood that even as it landed. But it landed all the same, on the one morning she had nothing to land on: the assumption that the stone at her throat and the name on her letter were a kind of welcome she had been issued at birth, when in truth they were the last warm things left of two people three days dead. For a moment she could not answer, and the silence stretched a beat too long, and she watched Alice register it without understanding it, watched the bright face flicker, uncertain whether it had given offense and how. The room's not mine, Viridia did not say. Nothing is, just now. She let the silence cost her the smile she might have given, and let Alice sit in not knowing why. It was the first thing between them that did not go smoothly, and it would not be the last; but it was the first.

Before either of them could mend it, a clear voice cut across the hall from the platform, and the last threads of conversation died at once.
...
The girls rose in a wave of scraping chairs and bright voices, gathering bags and gathering each other, already deciding in clusters where to go and who would walk with whom. Plans formed in seconds. Did you see, are you in the east wing, come find me at. The formed and friendly group simply picked itself back up and carried itself out the tall doors. The copper-haired girl passed at the head of it, and slowed as she came level with Viridia's chair, her eyes going again to the stone at the throat.

"Saeren," she said, reading the name off nothing, tasting it. "You'll want to keep that tucked under your collar, you know. People talk." She smiled, sweet and exact. "I'm only being kind. Welcome to Hazel." And she was gone before Viridia could decide whether it had been a warning or a threat, leaving the words sitting where she'd dropped them.

The sound of the crowd thinned down the carpeted hall until the great room had nearly drained.

Viridia stayed in her chair.

It was not a decision. Her body had declined to stand, and she let it, because the effort of rising and arranging her face felt like more than she had.

Her hand had found the stone again, the carved edges biting gently into her palm. None of them knew, the girls with their plans and their easy gravity. They walked out into the bright simple front of their lives and not one of them could have guessed that the quiet girl in the front row was drowning, and had been for three days, and was getting frighteningly good at doing it where no one could see. The pressure behind her eyes built. She breathed around it. She did not let it past. No one sees you do it, she told herself, in something close to her mother's voice. You decide who sees.
...
"The kind they have when someone's hurt and they're not saying who." She dropped her voice to a thrilled hush and touched two fingers to Viridia's sleeve, the confiding gesture of a girl handing over contraband. "You didn't hear it from me." And Della bounced ahead to find her own people, having delivered the thing she'd come to deliver, already, plainly, deciding how she would tell the next one, leaving the two of them to follow the current down.
...
"I could get used to this," she said, loading her plate with a happiness she made no effort to hide. Bacon, eggs, toast, more bacon. "At home it's porridge. It's *always* porridge. My nan thinks anything fried is a sin against the morning."
...
"I'm Mrs. Zoran, and I'll be your teacher this year," she said, all in a rush, as though she'd been waiting all summer to say it. "I do hope you're ready to learn and have a bit of fun while you're at it." And then she was off to greet the next table, and the next, leaving the two of them grinning at each other.
...
"Look at it," Alice breathed. "I didn't understand what she meant, about resonating. I thought it was teacher-talk. And then I picked this one up and it was like." She pressed it briefly to her chest. "Like it *recognized* me. Is that mad? That's mad. Ooh, I can't wait for tomorrow."
...
Not in the room. The corridor was empty. Watched across time. Someone in a strange hand had known she would be here, and packed her a thing thirsty enough to frighten her teacher, and told her in advance what to say. She had not done as the note said, not exactly; she had kept the focus, but on her own terms and in the open, and the open was the part the note had not wanted. She wondered, now, whether she had just spent something the stranger had meant her to keep. The seam meant to come apart into halves. The name with no dates. Her mother's *circumstances.* It was a door someone else had already walked through, ahead of her, leaving it on the latch. Behind the grief she heard herself want to know who, not the warm wanting of a girl handed a destiny, but the cold steady wanting of one who has found a stranger's footprints in her own house.
...
"Good afternoon, ladies. I am Mr. Cote, and I shall be teaching you the history of our people." His voice was deep and dry and entirely without hope. "It is my belief, and Headmistress Lightwell's, that by studying those who came before, you may contrive to make some *new* mistakes, rather than repeating the abundant old ones." He let that land on no one. "Open your texts. Read the first two chapters. When you have done, raise a hand and I shall give you a small quiz, after which you may go to your lunch." He folded his hands on the great shelf of his belly. "There will be no discussion. There is nothing in the first two chapters worth discussing. That comes later, when you are old enough to be disappointed by it."
...
"Ma'am." Amber's voice changed, the lounge going out of it, replaced by something more careful, a person picking her footing. "As you know, I've sponsored Viridia Saeren. A sponsorship usually buys a little room in a girl's schedule, so I've come to ask about hers."
...
Something shifted in the room. Lady Lightwell set down her pen. She picked her spectacles back up off the blotter and turned them over once in her fingers, slowly, and did not put them on. "Before you go on, Miss Summers," she said, and her voice had gone very level, very quiet, the dining-hall voice, the *I am not handling this one quietly* voice. "Be aware that what you are about to ask may cost you. Do you understand that?"
...
"Fine," she said, and the word came out tired, far more tired than a single word ought to be able to sound. "Amber Summers, you have used your one favor. There will not be another. Not for her, not for yourself, not for anyone. Do you understand me clearly?"
...
"So I did what any kid does," Amber said. "I tried to fix it. I knelt down between them and I reached for everything I had, all of it, every scrap, and I tried to make them be alive again." She smiled, and it was a terrible smile, fond and ruined at once. "Light mages aren't supposed to be able to touch death. It's not a light thing. But I didn't know that. I was eight. So I just *pushed,* with everything, until something tore."
...
The ground softened underfoot, all leaf-mould and the give of a thousand years of fallen things. The smell came up rich and dark, wet earth and rot and green growing over the rot, the whole patient cycle of a forest breathing in the gloom. Somewhere far off water moved. Somewhere nearer something with wings resettled itself with a sound like a sigh. Viridia found, to her surprise, that she was not afraid of it. After the gilded careful corridors of the school, where everything was assessed and everyone was ranked and a stone at your throat could change a stranger's whole face, there was something almost restful in a place that did not care who she was at all. The forest would have looked at the Headmistress and the gift-less and the High Chancellor himself with exactly the same green indifference. It was the first thing she had met in three days that wanted nothing from her.
...
Viridia stood in the green light with her cane in both hands and no idea at all of how to begin, which she had a feeling was going to be the way of most important things.
...
"I didn't know you could do that," Amber said weakly. Then the weakness went out of her, and something harder came up under it, and she crossed the clearing and took Viridia by the shoulders, none too gently, and looked into her face. "You did that on purpose," she said. It was not a question. Her voice had gone low and shaking. "I told you small. I made you *promise* small. Three pulses, a toad, I said it twice — and you stood there and opened yourself up like a slit throat. I felt it from the bench. I felt the bottom go out of you." She gave Viridia one small rough shake, fear wearing the coat of anger the way it does. "You could have died right there in the leaves and I'd have had to carry what was left of you back and tell Lightwell I let a girl burn herself hollow on her first afternoon in the forest. Don't you *ever* — " She stopped. She made herself stop, and let go, and stood breathing, and what came out next was quieter, and worse. "What is it in you that would rather die asking than live with a small answer? No. Don't tell me. I think I already know, and I don't like that I know it."

Viridia did not have an answer that would make it better, so she gave the true one. "I'm sorry I frightened you." She did not say *I'd do it again,* though it was sitting right there, because she did not think Amber could bear to hear it, and because she was not entirely sure it was the kind of thing you ought to say out loud.

*You were not meant to know,* Lor-ar said to Amber, of the shrinking, and chuffed, a sound that was unmistakably laughter, and stood, and gave himself a shake. Then his storm-eyes found the dried blood under her nose, and the amusement went out of them. *Your sponsor is right to be afraid,* he said, quieter. *You poured yourself out like a jug with no bottom, and you did it knowing. Someone will have to teach you where the bottom is, little one, and soon.* He turned his great head, slow, toward the deeper trees, where the green light failed into true dark, and held it there a moment, scenting. *And understand this, since you chose to learn it the hard way. A call that size does not stop at the edge of a clearing. It went out past me, past the named parts of the wood, and out there something heard it and did not come — which is worse than if it had. You have announced yourself, the once, to a hungry thing in the dark, and a thing like that does not forget the taste of a door thrown open. That is the tail your defiance has on it. You will carry it whether you meant to or not.* He let the silence sit a breath too long. *Up. You need to sleep before you fall down. I have decided I will permit it.*
...
She did not have it in her to argue further, and did not want to. She crawled in beside him, under the round window with the gold light fading out of it, and curled against the warm bulk of him. He ran warm, warmer than any animal had a right to, and there was that faint charge in the air around him still, the prickle of a coming storm held just at bay, and she put one hand into the impossible blue-green fur and felt the slow furnace of his breathing, and the grief and the drain and the careful held weight of three days all loosened their grip at once, and she was asleep before she had decided to be.

She did not dream, or if she did the dreams went where the others went now, down into the place she could not follow them. She slept the deep blank sleep of the truly spent. The school went on without her; the light left the window. Somewhere a tray of food was brought up, set on the nightstand, and went cold. Through all of it the small horned tiger lay against the wall with his storm eyes half-open, watching the door, exactly as he had said he would.
...
*That,* said Lor-ar, *is the whole of the world you were given. It is not the whole of the world.* He looked at her with something that was almost pity and almost patience and entirely ancient. *Your people were meant to hold both halves. Someone, long ago, took the other away. That is the brokenness. Not a flaw you were born with — a wound that was done to you, so long ago that you have forgotten it was ever a wound, and call the scar your nature.* He let the word sit between them, *wound,* and did not reach for it again, and would not say the rest, so that she was left holding the single terrible noun in the dark the way she held the stone at her throat: a small hard thing with edges, given to her to carry and not yet to understand.
...
Alice took her hands slowly down from her mouth. She looked at Lor-ar. Lor-ar looked at Alice. And then, instead of fear, instead of the dozen sensible reactions one might have on coming home to find a horned predator on the floor, Alice's whole face opened into the helpless friendly delight that Viridia was coming to understand was simply how Alice met the world.
...
Viridia listened, and watched Alice's hands as she said it, the way they kept smoothing the same fold of blanket flat and flat again, the way they had smoothed her skirt in the orientation hall, a body too full of good news to keep still under it. She was glad for Alice, genuinely, warmly glad, and underneath the gladness, so quiet she almost missed it in herself, was a thread of something more complicated. Alice was building a life here. A sponsor of her own, a wing of her own, a path of her own that belonged not to Viridia but to who Alice was going to become. Three days ago they had been two strangers at the outside edge of the same room. Now Alice had somewhere to go in the morning, somewhere that was hers. It was exactly what Viridia had wanted for her. It was also, she registered with a small private honesty, a door opening between them, the first hairline gap of two lives that had briefly been one and would now begin, gently, to be two again. She was happy for Alice. She was. And she was, very faintly, afraid of being left, which she recognized, the moment she felt it, as the same fear that had sent her into the forest to call for something that would *stay.*
...
She lay awake on purpose, which was new. For three nights she had lain awake because the grief would not let her go; tonight the grief was there, it was always there, but it was not the thing keeping her up. She was keeping herself up. She wanted, for once, to be alone with the inside of her own head, and the dark room with two sleeping breathers in it, Alice's soft and even, Lor-ar's a slow deep furnace-rumble at the foot of the bed, was the safest she had felt since the kitchen.
...
*Broken how,* Lor-ar had said, of her people. Not of her. *Your people are much diminished.* He had said it as though she were the exception. As though she were the whole thing and the rest of the world were the broken thing, which was so completely backwards from everything she had been told her whole life that it would not fit in her hands at all, except that some quiet part of her, the part that noticed the one detail that did not fit, had caught on it and held, the way you hold when a stranger says your true name.

She did not know what she was. That was the plain fact at the bottom of it. Three days ago she had been a grieving girl being delivered to a school, and now she was something the school had categories for and did not, she suspected, want. *Be careful who you let see you do it.* She understood the warning differently now. Her mother had not been talking about quiet, or watching, or grief. Her mother had been talking about *this,* the thing in the orb, the thing in her, the thing the world killed people for. Her mother had known, and buried the knowing inside everyday advice, and left it for her to find too late.
...
The half-moon moved a little in the round window. Lor-ar's breathing rose and fell. And Viridia Saeren, fourteen years old, who had come through the gate three days ago with nothing she could name, lay awake between the dark she had been given and the dark she was walking into. Somewhere past the glass, far out beyond the trimmed hedges, the night did not feel empty the way nights used to. It felt occupied, faintly, at the edge of her new sense, by something turned her way. She had no word for it yet. She would learn one soon enough, and wish she had not.
...
*Is it? I had not formed an opinion. I leave the weather to those who must walk in it.* He rose then, in the unhurried way of a creature who has never once been late for anything, and turned a slow circle on the blanket, and resettled with his chin on her ankle as though it had been put there for the purpose. *Your friend left a tray. The soup has gone cold a second time. You have a gift for letting soup die, little one. It is a small tragedy I have now watched twice.*
...
Between them, on the bare scorched earth, lay an egg. It was as long as Viridia was tall. The scarlet dragon bathed it in her fire, and now and then the black one leaned in and added a breath of his own, and his fire was not orange or red. It was black, a black flame with no light in it at all, and where it passed over the shell the shell seemed for an instant to drink the dark.
...
He did not seem to mind. "Near six thousand years," he said. "Varissa, near five. We were not young when the pact was made. We were there at the making of it. That is why it took us so hard when it woke. The old bindings sit deepest in the old ones. A younger creature might have felt your call as a tug and shrugged it off. We felt it as a summons we had sworn to in person, and there is no shrugging off a thing you swore to with your own mouth, even an age ago, even when keeping the word costs you a son." He looked at the egg. "We have had others. One did not live through the last war. We have tried, since, the two of us, for two hundred years. This is the first to quicken. And the pact gives him away the night he is born."
...
She was changed in that moment, and knew it as it happened. The firelight came up too bright, the crackle of the burning logs too sharp, the night air carrying scents she had no names for, resin and scorched stone and the clean cold of the heights above. The mana-sight, which she had held open all day by an act of will, dropped into place inside her and stopped being work, a thing she simply had now, the way she had her own two hands.
...
Raizen rode her shoulder, his tail wound twice round her arm, half-asleep and warm against her neck. Lor-ar padded along at her side in his house-cat size. Together the three of them were, she was fairly sure, the strangest thing this hallway had carried in its long and proper life, and the other girls gave them a wide berth and pretended not to stare, which only made the staring louder.
...
Viridia thought about it. She thought about the easy answers, *to learn, to do well, to make my parents proud,* the things you said to a teacher who was deciding what to make of you, and she found she did not want to give any of them. Partly because she suspected the woman across the desk would hear an easy answer for exactly what it was and think less of her for trying it. Partly because she was tired, and the question was a real one, asked plainly, and she had not been asked many real ones lately; everyone had been telling her things instead, large impossible things, and a question felt almost like a courtesy.
...
Dark mages. In a school for light mages. Walking the corridors in their stolen light, raising their hands and giving the right answers, writing home to families who had hidden them here because here was the one place in the country a dark-born girl might be safe, because the woman who ran it was one of them, and had built this whole proper, paneled, respectable institution as a hiding place in plain sight. Every one of those girls was one bad afternoon away from the thing that had been done to Jazen's sister, and every one of them came down to breakfast anyway and smiled at Mr. Cote, because pretending was the rent you paid to go on living.

The war was not coming to Hazel. It was already here, in the desks, behind the borrowed flames, and she would never again walk this corridor and think it only a corridor.
...
Lor-ar said nothing to that, which from Lor-ar was a kind of agreement, and the three of them went down together into the ordinary morning that Viridia would never again be able to see as ordinary.
...
She looked, and saw it: two distinct streams running up out of his core, one bright and one dark, each feeding its own flame, neither touching the other. And then, slowly, deliberately, he brought his paws together. The streams came with them. The two flames met.
...
Once, on the fourteenth night, Lor-ar broke off a lesson mid-shape and stood, ears forward, facing out past the treeline, and would not say what he had heard. Viridia turned the sight that way and found, far off past the forest, the same low greyness she had glimpsed from the assembly window weeks before, a thinning in the living threads of the land. Only it was not where it had been. Weeks ago it had sat behind the third ridge, a smudge at the limit of seeing. Now it had come forward to the second. She could measure it against the hills the way you measure a tide against a post, and the measuring was worse than the sight of it. "It's nearer," she said. "Two ridges nearer than the last time." Lor-ar's tail went still. *It moves faster than it did,* he said, and that word, *faster,* was the one that stayed with her, because it meant the thing had a speed, and a speed could be counted, and a thing you could count was a thing that would, on some particular day she did not yet know the number of, arrive. *What is it,* she asked, because for the first time it had a fixed mark and was no longer only a smudge she could doubt. He was a long moment answering, and when he did, he gave the thing a name, which was worse than no answer, because a name made it real. *Your kind has a word for it now, where there is anyone left to say words. The Hollowing.* He did not look away from the dark rim of the world. *Where the war has been hard and long, the living threads do not merely break. They are drawn out, drunk down, until the land has no thread left in it at all and nothing will grow and nothing will answer a shape. An emptiness with an edge, and the edge moves. That is what walks toward us, ridge by ridge.* He would say no more than that, only: *Mind your shape. We have less time than the spring would have you believe.* She took it in, and the lesson went on, but the ease had gone out of the night.

There were harder shapes, and dangerous ones, and Lor-ar doled those out slowly and would not be hurried. The hardest was not a shape at all but a use of one: setting a shape not into the air, where it spent itself at once, but *onto a thing,* so that it stayed. *A shape in the air is a word spoken,* he told her. *A shape laid into an object is a word written. It waits. It keeps. A focus is only an object somebody once wrote patience into.* He had her practise on a flat river-stone, drawing the gentle warming-shape onto its face with a fingertip wet in light, so that the stone held a low heat for an hour after she had walked away. It was finicky, exacting work, slower than anything in the air, because a written word that came out wrong did not simply gutter and vanish; it sat on the object and meant the wrong thing until you scraped it off.

She learned that the hard way. On the nineteenth night she tried to lay the warming-shape onto the iron bench-arm instead of a stone, impatient, hurrying it, and got one stroke of the shape inverted, and the iron did not warm. It went cold, a deep, drinking cold that bit straight through her sleeve and numbed two fingers to the knuckle before she snatched her hand back. The numbness did not lift that night. It did not lift in the morning. For nine days she could not feel the pads of two fingers, and had to watch her own hand when she held a pen, and Lor-ar, who did not often say *I told you,* did not need to. *The air forgives,* he said. *The object remembers. Remember that it remembers.* The feeling came back, in the end, in a slow prickling tide. But she had learned, in a way no warning would have taught her, that a shape written onto a thing was a different and graver order of magic than a shape thrown into the dark, and she set the lesson with the rest, on the long and growing list kept for a later she was beginning to suspect would not be a comfortable one.

There was, too, a shape Lor-ar would draw and then rub out at once, every time, and would not teach her, and would not name, and when she pressed him he only said *not yet, and perhaps not ever, and certainly not until you have learned that some words are easier to say than to call back.* She filed that away as well.
...
Amber came back from a job at the end of that week, and Viridia knew before she said anything that it had gone wrong, because Amber, who could make a face do whatever she asked it to, had not bothered to ask anything of it at all.

She found Viridia by the fountain after dark, which she had never done before; the night lessons were Viridia's secret and Amber's gift not to ask about, and the breaking of that custom was itself a kind of message. She sat on the bench without a joke ready.

"There was nearly a killing," she said. "In the capital. A dark mage, a baker, three children, never harmed anyone in his life, got named to the magistrates by a neighbour, and the decree was drawn up, and it went all the way to the desk for signing." She turned her pale focus-stone over and over in her fingers. "It didn't get signed. Somebody on the council lost their nerve at the last, or found a conscience, or counted votes and didn't like the sum. The man's alive. They let him go. This time."

"And if they hadn't," Viridia said.

"Then it would have been the next sanctioned killing." Amber looked at her, and the deflection that armoured her every other hour of the day was simply not there. "You weren't in the office when Lightwell laid it out, so I'll tell you the way she told me. Jazen has sworn that the next time the capital kills one of us by decree, he stops asking for peace. He's said it plainly, to people who carry his words. One signature. That's the whole of the distance left. It came that close this week, and nobody who matters even broke a sweat over how close. They'll draw up the next one. They always do." She stood. "I tell you because you should be training like it's coming, not like it's a story. It nearly came today. It will come on some ordinary Tuesday nobody's marked on a calendar, and the only question worth anything is how ready we are when it does."

She went back toward the dark school. Viridia sat a while longer with the cold fact of it: that the war was not a horizon after all. It was a number, and the number was one, and the count had very nearly reached it while she was learning to warm a river-stone. After that the shapes she practised did not feel like wonders anymore. They felt like a race.
...
The grief was still there. It would always be there; she had stopped expecting it to leave, and there was a kind of peace even in that, in no longer waking each morning to the small fresh shock of it being true. But it had shifted to one side, a little, and made space. She had believed, in the cold house, that loss filled a person edge to edge and left no room for anything else, ever. She had been wrong, the way she was learning she had been wrong about a great many things she had been told. A person could laugh on a spring lawn at a friend's silly joke, and the laughing did not betray the dead. That was the thing no one had told her. It did not betray them at all.

She thought of her mother, suddenly, and of how her mother had laughed, rarely, but fully, the whole of her face giving way to it. She thought her mother would have liked Alice. The tiger, the dragon, the language, Mrs. Zoran weeping over her flower — her mother would have liked all of it. The thought did not hurt the way it would have a month ago. It sat warm, alongside the grief, in the room the grief had made.

She was healing. She let herself, for one whole night, know it: a tiger and a dragon and a language and a friend and a teacher who had wept over a flower, a strange life assembled in the dark, underneath the grief and alongside it and not instead of it.

She kept the greyness on the second ridge out of her mind, and Amber's *one signature, that's the whole of the distance left,* with it. Not tonight. She had spent the worst weeks of her life arriving at a place where she had something to lose again, and she meant to have one night of it before she counted the cost.
...
There was no opening. She lunged left and stabbed right, a feint and a strike, exactly as the book described, and Venquar turned the spearhead aside with a flick of his own haft so casually that she felt the contempt in it even though there was none in his face.
...
She lay with her cheek against cold stone and counted them by ear, the way she counted everything: four horses, perhaps five, moving slow, the careful slow of men who were looking for something and had not yet decided it was here. A lantern swung somewhere through the trees and threw long shadows out across the clearing's edge, close enough that she watched the light crawl up the rock a hand's width from her face and stop. A voice said something she could not catch. Another laughed, low. The horses moved on. The lantern-light slid back down the rock and went away through the pines, north, the way it had come, and the wood's small sounds came creeping back one by one as the men took their noise with them.

No one moved for a long time after the last hoofbeat had faded.

"They have never come past the old ridge before," Nargash said at last, rising, and his voice had lost its earlier delight entirely. "Tell your Headmistress. The line where the soldiers stop has moved. It moves the way the Hollowing on the rim moves, and behind soldiers the Hollowing comes." He looked at Viridia in the dark, slit pupils wide. "You train as though the war is six weeks off. It walked within a spear's throw of you tonight. Train as though it is here." Then, because he was Nargash, and because the Dangris did not let a hard thing sit without a harder joke beside it: "Also you were too slow getting behind the rock. A patrol would have had you. We will work on that."
...
"You watched the body," Raizen said. "That is not luck. Luck does not look for the feint twice and remember it. Luck does not study a thing until it gives up its secret. You did that. You have always done that, with everything, since before you ever held a spear. It is the same thing you do to a room when you walk into it, and to a person when they lie to you. You only put a weapon in your hand and called it fighting." He nosed at her injured arm, gently. "Anything that keeps you alive is worth doing. Even getting cut, if the cut teaches you. Even losing, if you lose the right way."
...
She set her hand over the cut on her arm, and called up the shape for healing, the one Alice was learning too over in the bright ward, and fed her magic through it. The skin drew itself together under her palm, the parted edges knitting, the bleeding slowing and stopping; she felt the strange deep itch of muscle closing, and then it was a thin pink line and then it was only a smear of dried blood over whole skin. She did the same for her thigh, breathing through the odd discomfort of healing a deep bruise from the inside, until the throb faded and the leg was her own again. She was careful, now, to leave nothing. A single faint pink line she could not quite close had cost her an awkward lie to Alice last week — *caught it on a hedge,* which Alice had let lie the way she let everything lie, but which had sat badly in Viridia all the same, because the list of things she was keeping from the one person who told her everything was getting longer, and each new lie made the next one easier, and that ease was the part she did not like. She healed the leg until there was nothing left to explain. The not-leaving-marks was, she had begun to understand, its own kind of spear-work: a discipline she was learning because the alternative was being found out.
...
She climbed onto Raizen, into the natural seat between the great prismatic scales, and he stood, and she did not feel the cold of the height because the bond kept it from her, and Lor-ar watched them lift and then turned and ran for the school below, a streak of storm-colored fur threading the dark. From Raizen's back the forest fell away beneath her, black and endless and, she knew now, full of more life than anyone had ever told her; and off to the west, low against the mountain, the small red glow of Varissa's fire burned where it always burned. Farther still, past the fire, on the very rim of what the sight could reach, the land lay greyed and thinning, the Hollowing Lor-ar had named for her, that same distant wrongness. It sat on the second ridge now, where a fortnight ago it had sat on the third; she had a fixed mark for it tonight, the same as Nargash had a fixed mark for the patrol, and the two marks were moving the same direction, toward her, at a speed she could nearly put a number to. Raizen felt her notice it and asked, down the bond, *What is that.* *The Hollowing,* she said, giving him the name and not the dread under it, *where the war has drunk the land empty. Lor-ar says it is getting closer, and it is, I can measure it,* and they flew the rest of the way without speaking of it. Viridia ached in every limb. Her arm where the cut had been still tingled with the healing. And she was, to her own mild surprise, happy.
...
"He's coming for me," she said. "The Chancellor. The top student gets the private exercise, and we all know who's going to be the top student, and so the most powerful man in the country is travelling for days to watch a fourteen-year-old do an exercise. That's the shape of it."
...
"That," Lor-ar said at last, very softly, "is the cleverest fear I have heard out of a human mouth in a long while. You are right to assume he will bring a tool. You cannot know what it sees. So you will give it nothing to see." He rose, stretched the length of the sill, resettled. "From now until Friday, and on Friday most of all, your core stays banked. You will damp the light side down to what a clever first-year might have and no more. You will hold the dark side closed as if it were not there at all. You have learned to do this in the night lessons. Now you do it in daylight, in front of the most dangerous man you will ever meet, for as long as he chooses to look. Can you?"
...
Alice laughed, then caught herself, and put her hand over Viridia's on the bedspread, light, the way she did everything. "You're worried," she said. Not a question. Alice missed a great deal, on purpose, the way you miss things to be kind. She had not missed this. "You always go very still and very polite when you're worried. Like now."
...
"This," Nargash said, "is the Heart of the Spear. Among the Dangris it is given only to one who has shed blood and not run, and given back blood, and laughed about neither. It is made from the head of a spear that has killed in defense of the tribe. The metal remembers." He set it in her hand and closed her fingers over it, his hand swallowing hers whole, hot and dry. "Mark me: it is not given for skill. You have a season's skill, and the manners to know it is a season's. It is given for bearing, for the cut you took without complaint and the one you gave back. Skill we can teach you, and will, for years yet. Bearing a warrior is born with. You have it. I have looked, dragon-friend. There is no Heart in your people. They are very fine at building and very fine at growing and they have forgotten how to give a young warrior the thing that says: you are one of us, you have been tested, you will not stand alone. So. The Dangris give you ours. You are Kor-toh now, in the only part of it that matters, which is the part that comes when you call."
...
Raizen was silent under her for the length of three wingbeats. When he spoke, the dry warmth had gone out of his voice, and what was left was older than him, his father's grief and his mother's iron and his own newborn ferocity all braided together into something that did not sound newborn at all.
...
While they waited she let the sight drift out past the eastern wall, over the bare trees toward the far ridges, the small unbidden habit she could no longer stop herself making, and found the thing she had been finding for a week and wishing she would not. The Hollowing. The grey thinning in the living threads of the world, the country where the light was being drunk out of the land. It had crossed to the third ridge now. She was sure of it this time; she had counted ridges the way she counted everything, and a week ago it had stopped at the second. It came on the way the swept sand had been swept, patiently, before dawn, by a hand that wanted nothing left to draw the eye. She drew the sight back in and banked her face and told no one, because the two clocks she could feel running, the grey one creeping over the ridges and the unsigned one she had no eyes for at all, a decree on a desk in the capital, were the same clock told two ways, and both were counting down toward whatever was about to walk into this arena.

The thing they meant her to see arrived an hour after breakfast.

He came not by the gates but by portal, which she had not known the capital allowed, a vertical seam of light that opened against the far wall of the arena and let three figures step through before it sealed itself away. For the half-second the seam stood open, the mana-sight showed Viridia what lay on the other side of it. Not the bright ordered capital she had pictured, but a stretch of country gone wrong, its threads of life thin and greyed, the same low dimness she had glimpsed from the assembly window, only nearer now, and worse. Then the seam closed and took the sight of it with it. She marked the cold that went down her at the look of that land, and turned her face back to the careful nothing it was wearing. Two were examiners, an old woman and a wiry young man, both in the grey the capital's testers wore. The third was a short bald man in a white robe with a light-gold sash, and Viridia knew him before anyone announced him, because the whole assembled school went quiet around her in a wave that started at the front and reached the back, and because Lady Lightwell, standing at the head of them all, did a thing with her face that Viridia had been watching for and almost missed.
...
"Lady Lightwell." The Chancellor's voice carried without seeming to rise, a warm dry voice, grandfatherly, a voice built to put children at their ease. "What a very fine morning you've kept for us. And what a fine crop." His pale eyes moved over the assembled school, unhurried, pleasant, and where they passed the girls stood a little straighter without deciding to. "I do so love a test day. The whole future of our art, gathered in one cold courtyard, not one of them yet knowing what they'll become. Marvelous." He let his gaze travel the rows, slow, and Viridia kept her own face turned a few degrees down and to the side, the face of a first-year too shy to be looked at, and banked her core to a small ordinary flicker, and did not let the tightness in her chest become anything he could see.
...
"That do be a dangerous path," she said, not unkindly. "Magic that do touch the mind or the soul do go wrong easy, without great care. You do be clever. Cleverness without caution do dig its own grave. Mind that." She pushed the third button before Viridia could answer, and Viridia kept the warning, because it was a good one and freely given.
...
The young man's name was Tobias, and he sat cross-legged on the sand with a spear across his knees until she came, and then he rose in one easy motion that told her, before he ever set his feet, that he was very good. He asked to see her spear. She passed it to him butt-first, the way Venquar had drilled into her, and Tobias turned it in the light and his eyebrows climbed.
...
"Miss Saeren." Quina inclined her head. "You did impress the test with your reading of magic and your judgment where there was none easy to be had. Top marks." Tobias, beside her, added that her combat wanted only practice and a few more years, and passed her, and Viridia murmured her thanks, and the hall stayed silent, because everyone in it understood now what was coming, the old honor that had not been offered at Hazel in fifteen years.
...
"I cannot recall," he said, "another first-year who has done what you did today. Truly. The disc has not gone gold in this school in living memory. It is a remarkable thing." He stopped and looked at her, and behind the silver lenses his pale eyes did the pressing, looking thing she could feel and not see. "Quite remarkable. Tell me. When the test asked you the last question. The old one, the war council. You chose to spare them. Why?"
...
It was not water. She understood that in the first half-second, before the rest of it arrived: this was not magic water, not enchanted, not a thing a mage had made. This was magic itself. The source. The thing all the rest of it came from, the thing every focus and glyph and core in the world was only a borrowing of, and she had put her bare unguarded magic into it, and it answered her with everything it was.
...
The pact. The first one, made in the second war, between the people and the great beasts, the agreement that bound human and creature and let a girl summon a tiger and bond a dragon, and the grief in it, the cost, the thing each side gave up. The severing came after. The council of frightened mages at the marble table, the real one this time and not the test's echo of it, deciding the dark was too dangerous to be left whole in the world; their hands reaching into the source itself and *cutting,* deliberately, mankind's connection to the dark half of the gift, so that fewer children would be born able to touch it, so that the thing they feared would dwindle out of the world a generation at a time. So that was why dark mages were rare. Not rarer by nature. Made rarer, on purpose, by people afraid of what they could not rank, and the wound of that cut was still here, in the source, a place where the bright lattice ran thin and frayed where it should have run full.

There was more than the fact of it. The source did not give her dates or names; it gave her the feel of the thing, the way a memory gives you a kitchen before it gives you a year. The fear that had driven the cut was not the fear of monsters. It was the fear of equals. The dark mages of that age had not been more cruel than the light. They had been, some of them, more powerful, and harder to govern, impossible to count and rank and file into the neat shapes a frightened council liked. So the council had not fought them in the open, where it might lose. It had reached down into the root of the world and quietly throttled the supply of them, a generation at a time, a slow strangling dressed up as peace. And the satisfaction of the mages who had done it was the same satisfaction she had felt at the marble table in the test, the clean warm certainty of people who believe they are saving the world by deciding who gets to be in it. It made her sick in the way only true things made her sick. Her knees had found the cold stone floor without her deciding to kneel.

The light mages had not won the second war. They had simply made sure no one would ever be strong enough to start a third, and called the silence afterward a victory, and built schools to teach the children of the survivors that the dark had always been the smaller, lesser thing, a defect, a brokenness, when in truth it had been a garden the gardeners had poisoned because it grew taller than the wall. The beekeeper, Amber on the kitchen floor, Alice's stunted candle, every girl at Hazel wearing a pale stone over a dark one: every grief she had touched in a month ran back to this room and this cut.
...
"Once. Even if you found your way back, it would do nothing more." He had marked her glance toward where the portal had been. He marked everything. "It should not need saying that this is not a thing to discuss with your school friends. The reason we send only the top student is that we trust such a one to use new strength wisely. You strike me as wise." A pause she felt as a hook. "Do you believe you have that wisdom?"
...
She had been alone in the loudest room she had ever stood in that afternoon, the whole school on its feet and clapping for the wrong thing, none of them knowing what she had truly carried back through the seam. She was alone now too, with a tiger at her chest and a sleeping friend within reach. The aloneness was not the room. It was what she carried, and it would go where she went.
...
"Don't tell Della that. It's the best version." Amber's eyes moved over her, quick, the appraising flick of an older girl checking a younger one for damage she might be hiding. "Are you all right? Truly. Not the face you give the room. The other one."
...
"Deeply," Amber agreed. "A face that does nothing is a face that's busy underneath." She caught Viridia's eye for half a second, just half, the warning in it gentle and real, *be careful what you say even here,* and then turned it back into a joke before Alice could catch the weight of it. "Speaking of busy. Pembrook. I hear you set a third-year's wrist yesterday and didn't faint."

Alice flushed with pleasure and tried to hide it and failed, the way she always failed to hide a good thing. "Healer Brun let me do it myself. She said I had," and here Alice dropped her voice, reverent, "*calm hands.* She's never said that to anyone. Petra's been doing the helper rotation for two years and Healer Brun told *her* she had hands like a startled goose."
...
Amber was quiet a long moment. "Because of the stone," she said finally. "Your mother's stone. The dark-blue one. I saw it the day you came through the gates, before I saw anything else about you, before I knew you were quiet or clever or any of it. I saw a girl holding a grief the exact size of mine and holding it the exact way I learned to, so that not a soul would catch her at it." She looked out at the trees. "I was given a chance, when I was younger than you. Someone took a risk on a shattered girl and it's the only reason I'm alive. I told myself, when I came here, that if I ever saw a kid carrying what I carried, I'd give them the chance I got. I didn't think it'd be a three-day first-year with a stone and a face like a closed door. But there you were." The grin came back, but slower, with the truth still under it this time. "And then you went and summoned a tiger, so I think the universe was showing off. Don't let it go to your head."
...
"When the war comes," she said, at last, into the wind. The words cost her. They made the cold lake under her feet realer, the crack she was listening for nearer. But he was right; the world did not feel worse for the saying. If anything the warm room and the calm hands and the ruffled hair felt more precious held against the *when,* the way a candle is brightest in the room it cannot fill.
...
In the late afternoon she stopped overruling it. The wrongness had stacked up past the place where she could call it a frightened month, and so she did the thing her whole life had taught her to do: she acted on the detail that did not fit. She went to Lightwell.

She stood outside the warded office with the soldier-in-a-laborer's-coat and the too-good horses and the short-staffed kitchen all lined up in her, and she knocked, and when the voice told her to come she came, and she said it plainly. "Something is wrong. There's a man in the east corridor who walks like a soldier. The kitchens are short and no one will say why. A wagon came up the drive that wasn't right. I don't have proof. I have the feeling I get before a thing, and I've learned not to argue with it." She heard how thin it sounded, laid out, and laid it out anyway, because the cost of being wrong was a foolish hour and the cost of being right was everything.

Lady Lightwell took off her rose-tinted spectacles and looked at her for a long moment, and what was in her face was not surprise. That was the thing Viridia would turn over forever, after: the woman had not been surprised. "You see clearly," she said, after a silence that lasted too long. "You always have. It is the most dangerous thing about you, and the most useful, and I am sorry for both." She folded the spectacles in her hand. "It is handled, Viridia. Do you understand me? What is coming, I have known was coming, and I have made what arrangements can be made. There is nothing you can add to it but yourself, and yourself is the one thing I will not spend. You will go back to your room. You will keep hidden, exactly as you have learned to. You will not draw a single eye. That is not me dismissing you. That is me giving you the only order that keeps you alive. Will you obey it?"

"Alice is on a ward shift," Viridia said. It came out before she had decided to say it. "If something is coming, I should get her out. Bring her back to the room, or—"

"Alice is where she is needed, and where the wards are thickest, and where I would put a girl I wanted safe." Lightwell's voice did not soften, because softening it would have made it a lie. "Moving people tonight is how people are found. You will leave her where she is, and you will go to your room, and you will trust that I have counted the same heads you are counting. Go, Viridia. And whatever you hear in the night, you stay hidden. Promise me that."

And Viridia, standing in the warded office with every instinct in her screaming to gather the two people she loved and run, made the choice to obey. She told herself it was the disciplined choice, the survivor's choice, the choice Lightwell had earned the right to ask of her. She went back to her room and she left Alice three corridors away behind the thickest wards in the school, because the Headmistress had said the wards were thick and the heads were counted and the moving of people was how people were found, and because some part of Viridia, the tired grieving part, wanted very badly to be told that it was handled, that for once she could set a thing down and let an adult carry it.

She should not have left her. She would think that, after, on a great many sleepless nights, and she would never be able to prove it would have gone differently, which was the particular cruelty of it: not the certainty that she had chosen wrong, but the never-knowing. She had read the night right and then handed the reading to someone else to act on, and trusted the thickness of wards over the pull in her own chest. The wrongness she had been right about all day she had finally named out loud, and then she had walked away from it, on an order, because being told to do nothing was easier than deciding to do nothing herself.

* * *

The screams came in the deep middle of the night.

She had not meant to sleep at all. She had lain on top of the blankets in her training clothes with a spear within reach, obeying the letter of the order and breaking its spirit, ready, listening, certain she would not go under. Exhaustion had taken her anyway, the way it takes a body that has spent a month learning to be less than it is, and she went down into a thin grey doze full of corridors. And then the sound reached into it and dragged her up, muffled screams through stone, the wrong sound for a school at night, and Lor-ar was already off the bed and changing, swelling from cat to the full storm-colored bulk of him with a sound like a growl and a sound like the air before lightning, his fur crackling blue in the dark.
...
Lamps had been knocked from the walls. Flame climbed the old dry panelling. Smoke lay along the ceiling and reached down. There were bodies. Viridia made herself not look at them, made herself look only at the next thing and the next, because the cataloguing part could keep her alive but only if she did not let it stop on a girl she had eaten breakfast beside, face-down and still in the burning hall.
...
She did not answer. She was looking at Lor-ar, at the slow rise and fall of his side that told her he lived, and she was buying time with her silence the way she bought everything, by watching, by reading, by hunting the detail that would keep her alive. The captain held out his hand and a staff appeared in it, carved white wood, dense with enchantment, and she read it before he had finished summoning it, because reading it was the only weapon she had that he did not know she carried.
...
"You can plead all you like." He turned the staff in his hand, idle, certain. "The decree is signed. The punishment for harboring dark mages is death. All of you. The law is the law."

"I have girls of my own," he added, and the dreadful thing was that he meant it, that the cruelty had a tenderness folded into it that made it worse, not better. "Two. About your age. I came so that they grow up in a world where a dark mage is not free to do to them what your kind did at Harrow Field. You think you are the wronged one tonight. So does every soldier in this hall. That is what makes it a war and not a murder."

She understood it then in one cold beat, the whole shape of it dropping into place without his having to lay it out: the careful old man and his silver lenses, the visit that had never been about a ranking test, the headmistress read true through the glass and the decree that followed as surely as night. He had come for Lightwell. He had never seen Viridia at all. She had hidden exactly right, the way her mother taught her, and she had lived because of it, and everyone she could not hide was dying tonight because the woman at the center of it had finally run out of ways to hide herself.

While he talked, she worked.

She did it as Lor-ar had drilled her in the scorched ring, the thing the light mages never learned to fear because they had never had to: she reached out with the dark side of her gift, the hidden half, the half this whole school was built to pretend out of existence, and she inscribed a new rune onto the captain's staff from across the burning hall, fine and fast and silent, linking it to his own protection rune. An explosion rune. She had laid shapes onto objects a hundred times in the scorched ring, onto river-stones and bench-irons until her fingers learned the grave slow patience of it, *the object remembers,* and she had never once done it on a moving target in a burning room with her own death three strides off. The work was the same. The cost of getting it wrong was not.

And she got it wrong. The third stroke went in inverted, the way it had gone in on the iron bench-arm the night the cold ate two of her fingers, hurry doing to her hand now what it had done then; she felt the line take the wrong meaning the instant she set it, felt the rune turn from a thing that would feed the shield to a thing that would feed *her,* the drinking-cold already reaching back up the link toward the hand that had drawn it. There was no scraping it off. There was only laying a second, truer line over the first before it finished, fast, far too fast for the grave slow patience the work demanded, and she did it with the captain's hand already closing on the staff, did it with the cold biting up her wrist, did it knowing that if this stroke went wrong too she had just built her own death and handed it to a burning room.

It went in true. But the inverted line had already begun to draw, and it took its price on the way out: a fierce drinking cold bloomed up her left forearm and the skin there went white and then split, a long shallow burn-that-was-not-a-burn opening along the muscle where her own botched rune had fed on her before the true line smothered it. She bit down on the cry and locked it behind her teeth. Her arm hung wrong at her side, two fingers numb again and the forearm screaming, and she shifted the spear into the hand that still answered her. She tied the two runes together so that the one would feed the other, so that when he raised his shield, the shield itself would become the bomb, and the bubble that let nothing out would let nothing out.

It was, she understood even as she did it, a death symbol. Not the death-magic Drake had only begun to teach her. A simpler, colder thing. A killing made of someone's own defense. She did it anyway. She thought of Lor-ar smoking against the wall and the girl face-down in the hall and she did it anyway, and she felt something in her that she would have to look at later, much later, when there was a later, the ease of it, the way the cold clear cataloguing part of her had not flinched at all.
...
She pushed healing into him, the vast new core pouring through the shape Alice had taught her, and Lor-ar shuddered and coughed and got his legs under him, the worst of the burn closing under her hands. She put nothing into her own arm. There was not time, and the rune-cold was the cruel kind besides, the kind that resisted mending the way life-fire did; she had felt that even as it bit her. The arm would have to keep until later, or not at all. She wrapped it once, hard, in a strip torn from her own sleeve with her teeth and her good hand, to keep the wrongness in it from spreading down into the fingers she still needed, and let it be. And where the captain's life-fire had struck the tiger a long seam of skin stayed bare and scarred, the storm-colored fur refusing to come back over it however much of her core she poured in. She had seen that resistance once before, on a fourth-year's arm laid open by a dragon's claws, a lifetime ago. She stopped pouring. Some things did not knit, however whole the one doing the mending. She would have to learn that tonight along with the rest. She smothered the life-fire spreading up the wall with a slap of earth magic that buried it under a fall of conjured soil.
...
The school she had learned in a month was unmaking itself around her. The hallway-paintings she had been walked past on her first day, Verrane, the hawk portrait, all of it, were burning in their frames or already gone. The stones underfoot were hot. The smoke had a taste now, more than wood, a sweetness she refused to name. Twice soldiers came at them from side rooms and twice she met them, but the spear was a two-handed grammar and she had a hand and a half, the left arm answering late and weak where the rune-cold had eaten it, and the second man nearly had her for it. Her parry came a fraction slow; his blade slid off the haft and laid her open across the ribs, a hot line of pain, shallow only because Lor-ar hit him from the side the same instant and turned a killing thrust into a graze. She finished the man with the butt of the haft cracked across his temple and then the point while he reeled, and she came away knowing, in the cold clear part that did the counting, that without the tiger that one would have ended her, that the shield she had felt around herself all month was a thing she had imagined, that tonight she was exactly as killable as the girls face-down in the hall and only luckier. Each time her body did the thing her mind would not watch, the cold clear grammar of the Dangris, *watch the body, the body cannot lie,* and each time she came away with a little more of someone else's blood on her and a little more of her own, and a little more of herself folded down and put away. She did not let herself feel any of it. She banked it the way she banked her core, down into the place she did not visit, for the later that might or might not come. There would be a reckoning for what her hands were learning to do without flinching. There would not be one tonight. Tonight she only had to live, and get them out, and not look at the faces.
...
Viridia hated it. Every part of her wanted to go down those stairs and put her vast new furnace of a core into that fight beside the only adult who had ever seen her clearly and not flinched. And every part of her knew the woman was right, knew it the way she knew all the hardest things, in the place that kept her alive. She could not turn the duel. The Chancellor would win it; she could read that much in the patient economy of his castings, a man spending exactly enough and no more, while Lightwell spent everything and was magnificent and was, by inches, losing. *Do not try,* the order had said. She decided, crouched in the smoke of the gallery, to disobey one word of it in a way she could live with.

Not to fight him. She would lose that and be seen losing it. But the alcove was not yet sealed; the eight were not yet gathered; the portal was not yet cast, and all of it needed seconds Lightwell did not have to give, because the moment the Chancellor broke her the soldiers below would turn and the children would have no one between them and the fire. So Viridia did the small hidden thing instead of the large seen one. She reached out across the burning air with the dark half of her gift and read his thread as Lor-ar had drilled into her across a month of scorched-ring nights, the open core, the bright braided line of a mage's intent laid bare to anyone who knew to look and almost no one did. She found the rhythm of his attack, the half-beat where he gathered before each bolt of white fire, the breath a master takes without knowing he takes it. And into the floor of the dais beneath his lead foot, fine and fast and silent, she laid a single rune, the smallest she had, not a weapon, only a hitch, a thing to make the stone remember to be uneven for one stride. *The object remembers.* She had laid a hundred of them onto river-stones on quiet nights. She had never laid one under a man who could end her with a glance.

He gathered. He stepped. The stone caught his heel, the half-inch she had bought it, and his next bolt went wide of where Lightwell would have been and scorched the dais instead, and Lightwell, given the breath, drove a wall of shadow up between them and held. One beat. Two. It was nothing. It was everything: it was the seconds in which eight children could be put through a hole in the world.

And it nearly cost her the one thing she had left. The Chancellor's head came round, slow, the way a man turns at a sound behind him in an empty house, and his attention swept the gallery, and Viridia felt it pass over her cover like a cold hand laid flat against a door. After a month of being no one, of being less than she was, she had reached out and touched the most dangerous man alive, and for one suspended instant she felt him almost feel the place she was reaching from. She let go of the thread as if it had burned her and pressed flat into the dark behind the balustrade and did not breathe, and the cold hand moved on, finding nothing, returning to the duel it could not afford to lose. She had not been seen. She had been a hair from it.

She knew, crouched there with her heart slamming, what she had just done and what it meant. She had a furnace in her chest and a craft no one in that hall would have thought a fourteen-year-old carried, and she had spent it, the once, deciding the children's seconds, and she had spent it on the eight. She had not spent it reaching three corridors toward Alice. She would not be able to say, ever, whether she could have. Only that with the one decisive thing she had to give that night, she had aimed it at the many, from cover, and turned away from the dais before she could watch the price of it come due on Lightwell. She nodded once, though Lightwell had already looked away, back into the storm of the fight, and she turned and ran for the stairs with Lor-ar at her heels.

* * *

She found Amber at the foot of the hall, holding a shield.

Amber had backed herself into the alcove under the gallery stairs and thrown up a dome of protection, and behind it huddled the survivors she had managed to gather: three second-years, five third-years, all of them shaking, all of them crying or past crying. Amber's face was grey with strain, her chipped nails dug into her own palms, the dome flickering as soldiers threw spells against it from the open hall, and she was holding it, just, the artificial light-core stone at her throat blazing and the true shattered core beneath it screaming with the cost.

There were no first-years.

Viridia's eyes went over the huddled girls once, twice, the part of her that did the counting already counting and the rest of her refusing the count. Three second-years. Five third-years. No first-years. No long blond hair coming out of its plait. No freckles. No one with calm hands.
...
She had left her once already tonight. That was the thought that came, unbidden and merciless: she had stood in a warded office hours ago and been told the wards were thick and the heads were counted, and she had believed it because believing it was easier, and she had left Alice three corridors away. This was the second time the night had set the one against the many in front of her, and she already knew, sickly, what the cold counting part of her was going to choose, because it had chosen it once before sundown.

She stood at the edge of Amber's shield with the whole of her life narrowing to a single unbearable point.

She ran the arithmetic, because the arithmetic was the only thing that could carry her through it. Three corridors. Burning. Held by soldiers in disciplined ranks who had already killed everyone they had reached. Alice, if Alice still lived, on the far side of them, in a ward they had likely come to first, because a ward full of helpers was exactly the kind of room a captain clearing a building would mark for early. The odds that Alice was alive were already poor. The odds that Viridia could reach her through three burning soldier-held corridors, alone, and bring her back, were poorer. And every minute she spent on those odds was a minute Amber's shield came closer to failing, a minute eight living frightened children stood between an emptying alcove and a hall full of killers.
...
It tore into being beside her, the well's gift, easy in the scorched ring on a quiet night and not easy now: a portal was a shape held open by a steady hand, and her steady hand was the wounded one. The seam shuddered as she made it, edges crawling, wanting to close on the rune-cold that ran up the arm holding it open, and she had to pour core into it past what it should have cost, far past, to keep the hole in the world from guttering shut while children were standing in it. Lor-ar leapt through it and vanished and came back a breath later.
...
Amber looked at her, and for one second the dark humor was there, the armor, deployed against the unbearable one final time. "Worst gift I ever gave you," she said. "Told you." And she nodded, and stepped backward through the portal with her hands still raised holding the shield, and the moment she crossed, the golden dome winked out, and the whole hall came in at once.

For a heartbeat Viridia was alone in the open with the seam shuddering at her elbow and a wall of soldiers' fire already loosed at the dropped shield, and the portal, fed by a failing arm, began to close on its own a beat before she meant it to, the edges rushing inward toward the gap she still had to fit herself through. The seam narrowed against her shoulder as she went, the cold of it dragging at her wounded arm like a closing door on a sleeve. She threw the last of what she had down into it, not to hold it open but to fling herself through before it ate her. She went through sideways and falling, the spellfire lighting the air white behind her. The seam sealed shut on the heel of her boot, shearing the leather clean off, a hair ahead of the fire that came screaming into the space where she had just been.
...
They were in the woods, tall trees black against a bright full moon, and the rescued girls were crowded together a little way off, shivering, some of them sitting down hard in the leaf litter, some of them weeping openly now that the running was done. Amber had slumped to the ground where she stood, the drain hitting her all at once, the holding finally over, her face the color of ash. Lor-ar stood at Viridia's side, the long bare scar across his flank where the life-fire had been and would always be now, a mark that no amount of her would ever take back, his head up, scenting the dark. Viridia stood barefoot on one foot in the leaf litter, her left arm bound in its bloodied strip of sleeve and held against her, the ribs under her other side burning where the blade had grazed her, and she understood, standing there, that she had walked out of that hall by the width of a tiger's leap and a boot heel, and not by anything that deserved to be called safety. The arm would scar like Lor-ar's, she thought distantly. The rune-cold had gone too deep and was the resisting kind. She would carry the night on her skin the way he would, the two of them marked the same, and there was a grim small comfort in that she did not examine.
...
She thought, walking away from it, of all the things the fire was eating. Her mother's spellbook, with the family tree a thousand years deep and the one name on it that carried no dates, the name that fit no pattern, the riddle she had meant to take apart some safer night and never had. It was ash now, and for one cold moment she believed the question had gone into the ash with it, the single thread back into her own blood burned out of the world before she had learned to read it.

Then she made herself think clearly, the way the cold part of her thought, and saw that the book had only ever been a copy. The names were older than the paper they were written on. The blood that carried them was still walking through the dark wood in her own two legs, and the well under the world had held her mother's thread plain and whole and waiting; whatever that dateless ancestor had been, the well would know it, because the well knew everything that magic had ever touched, and her mother's line ran straight down into it. And there was Drake, six thousand years old, who kept the oaths of families further back than any book; and Varissa, who had handed a dragon to her bloodline for reasons no one had yet explained. The book was gone. The question was not. It had simply lost its easiest door and would have to be opened by a harder one, and she was learning, this year, to open harder doors. She named the loss, and beside it, deliberately, she set the route around it, so that grief would not be the only thing she carried out of the fire. And the letter from Bella she had read every night and held to her chest in the dark. Her focus, the silver rod with the Moravian inscription, the cane Mrs. Zoran had primed for her, gone. The bright ward where Alice had learned she had calm hands. The scorched ring in the forest where the Dangris had taught her, though that at least was outside the walls and might still stand. The frightening table. The lamplit room that had been, for a span of two weeks, the first place that felt like hers. All of it, burning, behind her, while she walked away with a spear and a quiver and a tiger and the clothes she had died in, almost, and nothing else. She had arrived at Hazel with three suitcases and a grief she could not name. She was leaving it with less luggage and more grief and a great deal she had not had before, and she could not yet decide whether that was a fair trade or the cruelest one imaginable, and she suspected she would not be able to decide for a long time.
...
She worked her way quietly down the line of walking children as they went, falling into step beside one and then another, and she asked each of them, low, so as not to start a panic, the same question. "When you came down from the dormitories. Did you come past the medical ward? Did you see anyone come out of it?" She asked the second-years and she asked the third-years, one by one, the soot-faced girl and the small one and all the rest, and she kept her voice even and kind and gave no sign of what the answer meant to her, because they had enough to carry without carrying her fear as well.
...
"Sorry," he said, stepping closer, the apology rough and real. "I'm sorry. Lightwell didn't tell me you were coming. I saw a group come out of the trees at night, this close to the camp, I assumed—" He stopped himself. His eyes went over the soot-streaked children, the slumped exhausted Amber, the great singed tiger, the slight silver-blonde girl unmoving at the center of it with a spear in her hand and a quiver on her back and a stranger's dried blood on her arms, and something in his face shifted, a careful man recalculating. "My name's Jazen," he said, and held out his hand.
...
"Not at all." Jazen was unraveling another ward, his brow furrowed with the work. "I've found a way to make a fixed place invisible. Properly invisible, from the outside. It costs an enormous amount of magic to hold, so there are only three of us in the camp who can power it, which is why one of us has always to be inside the wards." The last of the magic dissolved under his hands and he let out a breath, and a flicker of real pleasure crossed his tired face. "It's the trickiest piece of magic I know. It feels good every time it works. Go on. Get your people down to the fire in the middle of the village and warm them. I'll set the wards again and meet you there."
...
For a moment she thought she had said too much, or the wrong thing, the way the wrong thing was so easy to say to grief. Jazen's jaw worked. He looked down into the fire and a single tear cut a clean line through the soot and sweat on his face and dropped off his chin into the dark, and he let it, did not wipe it, the way a man does not wipe a thing he has decided he has a right to. Viridia thought of her own face, dry, always dry, and felt something almost like envy of him, that he could stand in firelight in front of a stranger and let his grief run down his face and not be ashamed. She had never once been able to do it. Grief was grief, she decided, and took the shape the vessel gave it; his shape and hers were only the same water poured into different cups.

"She used to write to me," he said, after a while, his voice gone rough and low. "Twice a year. Never signed. Never said anything that could be read by the wrong eyes. Just—weather. How the school was. A line about a student now and then, the ones she was proud of. I burned every letter the day it came; we both knew the rule. But I'd read them ten times first." He drew a slow breath. "There won't be any more letters. That's the thing I can't get my head round. Not that she's gone. People go; I know that better than most. That there won't be any more letters." He looked up at Viridia, and his wet eyes were steady. "Was she one of them? The students she was proud of? Did she ever say a word about a quiet first-year with a stone she couldn't put down?"
...
"Enough," he said, his voice rougher now but level. "You've all had the worst night of your lives. I'll take you to quarters. We'll talk about what comes next in the morning." He led them to two houses at the end of a narrow lane, with a fire burning low in front, and held the door of one open for the children and Amber to file through, silent and stumbling and spent. As Viridia moved to follow, he caught her by the shoulder, lightly, careful of the bound arm he had already noted and said nothing about, and stopped her.
...
There was no bond. There had never been a bond. Alice was a friend, not a true-bonded creature; there was no thread between them, no warm certain link, no way at all to reach across the dark and feel whether she was alive or dead. Viridia knew that. She had always known that. And still, in the worst hour of the worst night, her grieving mind reached for Alice the way it reached for Raizen, expecting the thread, needing the thread, and found only the place where a thread would have been if the world were kinder, an absence, a nothing, her reaching hand closing on empty dark.
...
It was not like reaching for the dead. She had reached for her parents a hundred times in the small hours and met the closed finality of a thing that was over, a door that would not open because there was no longer a room behind it. This was a door she could not find at all. Alive somewhere in the dark and needing her, or dead in a burning ward and past all needing, and no way to know which, the two of them braided into one unbearable cord. The dead you bury. The missing you carry.

And she lay in the dark of a stranger's camp with a tiger at her back and a dragon at the far end of one thread and her best friend at the far end of no thread at all, reaching and reaching for a bond that did not exist, for the only person who might tell her whether the person she loved most in the world was alive, and finding, each time, only the silence where the answer would have been, and that silence was the loneliest thing she had ever held, lonelier than the kitchen, lonelier than the cave, the specific and bottomless loneliness of not knowing, and being unable, by any magic in the world or out of it, to find out.
...
Her last clear thought before it took her was Jazen's, low at the door. *Come find me when you wake.* He had buried his mother tonight without a body, the same as she was burying Alice, and he had still looked at her across the fire like a man who had recognized the start of something. Whatever Lightwell had been keeping her for, it had not burned with the school. It was waiting for her in the morning, in a camp full of people the capital had sworn to end, and for the first time since the gate she found she wanted to know what it was.
...
She saw, as she went, the shape of the life these people had built in their box of invisible air. A blacksmith's shed, the fire already going. A woman teaching three small children their letters on slates at a long table in the open, and Viridia slowed at that without meaning to, because the symbols on the slates were not the ones she had been taught at Hazel; they were older, rounder, and one of them, with a small jolt, she knew for a Moravian character, taught here to dark-mage children as a matter of course, the language the light schools pretended was dead being passed to six-year-olds over breakfast as though it had never been anything but alive. A whole world, hidden under the wards. A whole way of being that the capital had spent six hundred years trying to convince itself it had already destroyed, going on, quietly, teaching its children to read. It steadied something in her she had not known was unsteady. Whatever happened on the road to the capital, this had survived. People like her had found a way to go on being people, in secret, in the dark, and they had not gone small; they had gone hidden, which she was learning was a different and braver thing.
...
She had arrived at Hazel six weeks ago in the back of a motorcar, three days orphaned, with three suitcases and a stone she gripped when she was drowning and a silver focus she could not read and a single overwhelming want, which was to be unseen, to make herself so small and quiet that the grief and the world would both pass over her without noticing she was there.
